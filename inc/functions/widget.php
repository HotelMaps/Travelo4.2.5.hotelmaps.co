	...
	function widget( $args, $instance ) {
		...
		if ( trav_get_current_style() == 'modern' ) {
			...
			if ( ! empty( $instance['content'] ) ) {
				echo '<p class="description">' . do_shortcode( $instance['content'] ) . '</p>';
			}
			echo '<div class="contact-info">';
			if ( ! empty( $instance['phone_no'] ) ) {
				echo '<span class="phone-num"><i class="fas fa-phone-volume"></i> ' . esc_html( $instance['phone_no'] ) . '</span>';
			}
			if ( ! empty( $instance['email'] ) ) {
				echo '<span class="email-address">' . esc_html( $instance['email'] ) . '</span>';
			}
			echo '</div>';
...
class TravSocialLinksWidget extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		if ( trav_get_current_style() == 'modern' ) {
			...
			if ( isset( $instance['style'] ) && ( $instance['style'] == 'style1' ) ) {
				$class_name = 'square-shape-icon';
			} else {
				$class_name = 'circle-shape-icon';
			}

			?>

			<div class="social-icons <?php echo $class_name; ?>">
				<?php if ( ! empty( $instance['rss_link'] ) ) : ?>
					<a title="rss" class="rss-link" href="<?php echo esc_url( $instance['rss_link'] ); ?>" target="<?php echo esc_attr( $instance['linktarget'] ); ?>" data-toggle="tooltip"><i class="fas fa-rss"></i></a>
				<?php endif; ?>

				<?php if ( ! empty( $instance['twitter_link'] ) ) : ?>
					<a title="twitter" class="twitter-link" href="<?php echo esc_url( $instance['twitter_link'] ); ?>" target="<?php echo esc_attr( $instance['linktarget'] ); ?>" data-toggle="tooltip"><i class="fab fa-twitter"></i></a>
				<?php endif; ?>

				<?php if ( ! empty( $instance['google_link'] ) ) : ?>
					<a title="googleplus" class="google-link" href="<?php echo esc_url( $instance['google_link'] ); ?>" target="<?php echo esc_attr( $instance['linktarget'] ); ?>" data-toggle="tooltip"><i class="fab fa-google-plus-g"></i></a>
				<?php endif; ?>

				<?php if ( ! empty( $instance['facebook_link'] ) ) : ?>
					<a title="facebook" class="facebook-link" href="<?php echo esc_url( $instance['facebook_link'] ); ?>" target="<?php echo esc_attr( $instance['linktarget'] ); ?>" data-toggle="tooltip"><i class="fab fa-facebook-f"></i></a>
				<?php endif; ?>

				<?php if ( ! empty( $instance['linkedin_link'] ) ) : ?>
				<a title="linkedin" class="linkedin-link" href="<?php echo esc_url( $instance['linkedin_link'] ); ?>" target="<?php echo esc_attr( $instance['linktarget'] ); ?>" data-toggle="tooltip"><i class="fab fa-linkedin-in"></i></a>
				<?php endif; ?>

				<?php if ( ! empty( $instance['youtube_link'] ) ) : ?>
					<a title="youtube" class="youtube-link" href="<?php echo esc_url( $instance['youtube_link'] ); ?>" target="<?php echo esc_attr( $instance['linktarget'] ); ?>" data-toggle="tooltip"><i class="fab fa-youtube"></i></a>
				<?php endif; ?>

				<?php if ( ! empty( $instance['pinterest_link'] ) ) : ?>
					<a title="pinterest" class="pinterest-link" href="<?php echo esc_url( $instance['pinterest_link'] ); ?>" target="<?php echo esc_attr( $instance['linktarget'] ); ?>" data-toggle="tooltip"><i class="fab fa-pinterest-p"></i></a>
				<?php endif; ?>

				<?php if ( ! empty( $instance['vimeo_link'] ) ) : ?>
					<a title="vimeo" class="vimeo-link" href="<?php echo esc_url( $instance['vimeo_link'] ); ?>" target="<?php echo esc_attr( $instance['linktarget'] ); ?>" data-toggle="tooltip"><i class="fab fa-vimeo-v"></i></a>
				<?php endif; ?>

				<?php if ( ! empty( $instance['skype_link'] ) ) : ?>
					<a title="skype" class="skype-link" href="<?php echo ( $instance['skype_link'] ); ?>" data-toggle="tooltip"><i class="fab fa-skype"></i></a>
				<?php endif; ?>

				<?php if ( ! empty( $instance['instagram_link'] ) ) : ?>
					<a title="instagram" class="instagram-link" href="<?php echo esc_url( $instance['instagram_link'] ); ?>" target="<?php echo esc_attr( $instance['linktarget'] ); ?>" data-toggle="tooltip"><i class="fab fa-instagram"></i></a>
				<?php endif; ?>

				<?php if ( ! empty( $instance['dribbble_link'] ) ) : ?>
					<a title="dribble" class="dribbble-link" href="<?php echo esc_url( $instance['dribbble_link'] ); ?>" target="<?php echo esc_attr( $instance['linktarget'] ); ?>" data-toggle="tooltip"><i class="fab fa-dribbble"></i></a>
				<?php endif; ?>

				<?php if ( ! empty( $instance['flickr_link'] ) ) : ?>
					<a title="flickr" class="flickr-link" href="<?php echo esc_url( $instance['flickr_link'] ); ?>" target="<?php echo esc_attr( $instance['linktarget'] ); ?>" data-toggle="tooltip"><i class="fab fa-flickr"></i></a>
				<?php endif; ?>

				<?php if ( ! empty( $instance['tumblr_link'] ) ) : ?>
					<a title="tumblr" class="tumblr-link" href="<?php echo esc_url( $instance['tumblr_link'] ); ?>" target="<?php echo esc_attr( $instance['linktarget'] ); ?>" data-toggle="tooltip"><i class="fab fa-tumblr"></i></a>
				<?php endif; ?>

				<?php if ( ! empty( $instance['behance_link'] ) ) : ?>
					<a title="behance" class="behance-link" href="<?php echo esc_url( $instance['behance_link'] ); ?>" target="<?php echo esc_attr( $instance['linktarget'] ); ?>" data-toggle="tooltip"><i class="fab fa-behance"></i></a>
				<?php endif; ?>

				<?php if ( ! empty( $instance['deviantart_link'] ) ) : ?>
					<a title="deviantart" class="deviantart-link" href="<?php echo esc_url( $instance['deviantart_link'] ); ?>" target="<?php echo esc_attr( $instance['linktarget'] ); ?>" data-toggle="tooltip"><i class="fab fa-deviantart"></i></a>
				<?php endif; ?>

				<?php if ( ! empty( $instance['soundcloud_link'] ) ) : ?>
					<a title="soundcloud" class="soundcloud-link" href="<?php echo esc_url( $instance['soundcloud_link'] ); ?>" target="<?php echo esc_attr( $instance['linktarget'] ); ?>" data-toggle="tooltip"><i class="fab fa-soundcloud"></i></a>
				<?php endif; ?>

				<?php if ( ! empty( $instance['stumbleupon_link'] ) ) : ?>
					<a title="stumbleupon" class="stumbleupon-link" href="<?php echo esc_url( $instance['stumbleupon_link'] ); ?>" target="<?php echo esc_attr( $instance['linktarget'] ); ?>" data-toggle="tooltip"><i class="fab fa-stumbleupon"></i></a>
				<?php endif; ?>
		...
		<p>
			...
			<select class="widefat" id="<?php echo esc_attr( $this->get_field_id('style') ); ?>" name="<?php echo esc_attr( $this->get_field_name('style') ); ?>">
				...
				foreach ( $styles as $key=>$value ) {
					echo "<option " . selected( $instance['style'], $key, false ) . " value='" . esc_attr( $key ) . "'>" . esc_html( $value ) . "</option>";
				} ?>
			</select>
		</p>
		<p>
			...
			<select class="widefat" id="<?php echo esc_attr( $this->get_field_id('linktarget') ); ?>" name="<?php echo esc_attr( $this->get_field_name('linktarget') ); ?>">
				...
				foreach ( $linktargets as $key=>$value ) {
					$selected = "";
					echo "<option " . selected( $instance['linktarget'], $key, false ) . " value='" . esc_attr( $key ) . "'>" . esc_html( $value ) . "</option>";
				} ?>
			</select>
		</p>
		<p>
 ...
 */
if ( ! class_exists( 'TravSettingsWidget') ) :
    class TravSettingsWidget extends WP_Widget {

        public function __construct() {
            
            parent::__construct( false, __( 'Travelo Currency&Language Switcher', 'trav' ) );
        }
        ...
        public function widget( $args, $instance ) {
			...
			if ( trav_is_multi_currency() && trav_get_opt( 'header_currency_switch' ) ) : ?>
            ...
            if ( $language_count > 1 && trav_get_opt( 'header_lang_switch' ) ) :
        ...
        public function form( $instance ) {
            // Output admin widget options form
            $defaults = array( 'title' => __( 'Currency & Language Settings', 'trav' ) );
            $instance = wp_parse_args( (array) $instance, $defaults ); ?>

            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('title') ); ?>"><?php _e('Title', 'trav') ?>:</label>
...
if ( ! class_exists( 'TravHtmlBlockWidget' ) ) {
	class TravHtmlBlockWidget extends WP_Widget {

		function __construct() {
			
			$args = array( 
				'label'			=>	esc_html__( 'Travelo HTML Block', 'trav' ),
				'description'	=>	esc_html__( 'Display the selected HTML Block.', 'trav' ),
			);
		
			parent::__construct( 'trav-html-block-widget', esc_html__( 'Travelo HTML Block', 'trav' ), $args );
		}
		...
		function widget( $args, $instance )	{
			...
			echo trav_shortcode_html_block( array( 
					'block_id' => $block_id 
				) );
		...
		function form( $instance ) {
			...
			?>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php echo esc_html__( 'Title', 'trav' ); ?>:</label>
				<input type="text" class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" value="<?php echo esc_attr( $instance['title'] ); ?>" />
			</p>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'html_block' ) ); ?>"><?php echo esc_html__( 'HTML Block', 'trav' ); ?>:</label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'title_option' ) ); ?>"><?php echo esc_html__( 'Widget Title Option', 'trav' ); ?>:</label>
				<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title_option' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title_option' ) ); ?>">
					<option value="widget_title" <?php selected( 'widget_title', $instance['title_option'] ); ?> ><?php echo esc_html__( 'Use Custom Title', 'trav' ); ?></option>
					<option value="block_title" <?php selected( 'block_title', $instance['title_option'] ); ?> ><?php echo esc_html__( 'Use Original Block Title', 'trav' ); ?></option>
				</select>
			</p>			
			<?php 
		}
...
function trav_register_widgets() {
	if ( trav_get_current_style() == 'default' ) {
		...
		register_widget( 'TravSettingsWidget' );
	} else {
		register_widget( 'TravContactWidget' );
		register_widget( 'TravSocialLinksWidget' );
		register_widget( 'TravSettingsWidget' );
		register_widget( 'TravHtmlBlockWidget' );		
	}
}
