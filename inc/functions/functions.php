...
if ( ! function_exists( 'trav_init' ) ) {
    function trav_init() {
        ...
        if ( trav_get_current_style() == 'modern' ) {
            register_nav_menu( 'mobile-side-menu', esc_html__( 'Mobile Side Navigation', 'trav' ) );
        }
        ...
        add_action( 'redux/options/travelo/saved', 'trav_compile_theme_css', 10 );
        add_action( 'redux/options/travelo/import', 'trav_compile_theme_css', 10 );
        add_action( 'redux/options/travelo/reset', 'trav_compile_theme_css', 10 );
        add_action( 'redux/options/travelo/section/reset', 'trav_compile_theme_css', 10 );
    ...
    function trav_register_required_plugins() {
        $plugins = array(
            array(
                ...
                'required'              =>  true,
                'image_url'             =>  TRAV_TEMPLATE_DIRECTORY_URI . '/images/admin/plugins/redux_options.jpg',
            ...
            array(
                ...
                'slug'                  =>  'meta-box',
                'required'              =>  true,
                'image_url'             =>  TRAV_TEMPLATE_DIRECTORY_URI . '/images/admin/plugins/metabox.jpg',
                'check_str'             =>  'RWMB_Loader'
            ),
            array(
                'name'                  =>  'MB Term Meta',
                'slug'                  =>  'mb-term-meta',
                'source'                =>  'https://c-themes.com/plugins/mb-term-meta.zip',
                'required'              =>  true,
                'version'               =>  '1.2.10',
                'force_activation'      =>  false,
                'force_deactivation'    =>  false,
                'image_url'             =>  TRAV_TEMPLATE_DIRECTORY_URI . '/images/admin/plugins/mb-term-meta.jpg',
                'check_str'             =>  'MB_Term_Meta_Loader'
            ),
            array(
                'name'                  =>  'Meta Box Conditional Logic',
                'slug'                  =>  'meta-box-conditional-logic',
                'source'                =>  'https://c-themes.com/plugins/meta-box-conditional-logic.zip',
                'required'              =>  true,
                'version'               =>  '1.6.13',
                'force_activation'      =>  false,
                'force_deactivation'    =>  false,
                'image_url'             =>  TRAV_TEMPLATE_DIRECTORY_URI . '/images/admin/plugins/mb-conditional-logic.jpg',
                'check_str'             =>  'MB_Conditional_Logic'
            ),
            array(
                'name'                  =>  'Meta Box Tabs',
                'slug'                  =>  'meta-box-tabs',
                'source'                =>  'https://c-themes.com/plugins/meta-box-tabs.zip',
                'required'              =>  true,
                'version'               =>  '1.1.8',
                'force_activation'      =>  false,
                'force_deactivation'    =>  false,
                'image_url'             =>  TRAV_TEMPLATE_DIRECTORY_URI . '/images/admin/plugins/metabox-tabs.jpg',
                'check_str'             =>  'MB_Tabs'
            ),
            array(
                'name'                  =>  'Meta Box Group',
                'slug'                  =>  'meta-box-group',
                'source'                =>  'https://c-themes.com/plugins/meta-box-group.zip',
                'required'              =>  true,
                'version'               =>  '1.3.12',
                'force_activation'      =>  false,
                'force_deactivation'    =>  false,
                'image_url'             =>  TRAV_TEMPLATE_DIRECTORY_URI . '/images/admin/plugins/metabox-group.jpg',
                'check_str'             =>  'RWMB_Group'
            ),
            array(
    ...
    function trav_get_date_format( $language='' ) {
        ...
        if ( isset( $trav_options['date_format'] ) ) {
            if ( $language == 'php' ) {
                ...
                if ( trav_get_current_style() == 'modern' ) {
                    return str_replace( 'YY', 'YYYY', strtoupper( $trav_options['date_format'] ) );
                }
    ...
    function trav_update_user_recent_activity( $post_id ) {
        if ( is_user_logged_in() ) {
            ...
            if ( ! empty( $recent_activity ) ) {
                ...
                if ( ! empty( $recent_activity_array ) && is_array( $recent_activity_array ) ) {
...
if ( ! function_exists( 'trav_get_available_modules' ) ) {
    function trav_get_available_modules() {
        ...
        if ( empty( $trav_options['disable_flight'] ) ) $modules[] = 'flight';
        return $modules;
    }
}
...
if ( ! function_exists( 'trav_captcha_form' ) ) {
    function trav_captcha_form() {
        if ( trav_get_current_style() == 'modern' ) {
            trav_get_template( 'captcha-form.php', '/templates/modern/booking' );
        } else {
...
if ( ! function_exists( 'trav_terms_form' ) ) {
    function trav_terms_form() {
        if ( trav_get_current_style() == 'modern' ) {
            trav_get_template( 'terms-form.php', '/templates/modern/booking/' );
        } else {
