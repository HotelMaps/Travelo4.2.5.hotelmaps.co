...
/*
 * register html block custom post type
 */
if ( ! function_exists( 'trav_register_html_blocks' ) ) {
	function trav_register_html_blocks() {
		$labels = array(
			'name'					=> _x( 'HTML Blocks', 'Post Type General Name', 'trav' ),
			'singular_name'			=> _x( 'HTML Block', 'Post Type Singular Name', 'trav' ),
			'menu_name'				=> __( 'HTML Blocks', 'trav' ),
			'all_items'				=> __( 'All Items', 'trav' ),
			'new_item'				=>	__( 'New Item', 'trav' ),
			'view_item'				=> __( 'View Item', 'trav' ),
			'add_new_item'			=> __( 'Add New Item', 'trav' ),
			'add_new'				=> __( 'Add New', 'trav' ),
			'edit_item'				=> __( 'Edit Item', 'trav' ),
			'update_item'			=> __( 'Update Item', 'trav' ),
			'search_items'			=> __( 'Search Item', 'trav' ),
			'not_found'				=> __( 'Not found', 'trav' ),
			'not_found_in_trash'	=> __( 'Not found in Trash', 'trav' ),
			'parent_item_colon'		=> __( 'Parent Item:', 'trav' )
		);

		$args = array(
			'label'					=> __( 'html_block', 'trav' ),
			'description'			=> __( 'HTML Blocks for custom HTML to place in your pages', 'trav' ),
			'labels'				=> $labels,
...
function trav_admin_edit_html_blocks_columns( $columns ) {

	$columns = array(
		'cb'		=> '<input type="checkbox" />',
		'title'		=> __( 'Title', 'trav' ),
		'shortcode'	=> __( 'Shortcode', 'trav' ),	   
		'date'		=> __( 'Date', 'trav' ),
	);
...
function trav_shortcode_html_blocks_columns( $column, $post_id ) {
...
add_filter( 'manage_edit-html_block_columns', 'trav_admin_edit_html_blocks_columns' );
add_action( 'manage_html_block_posts_custom_column', 'trav_shortcode_html_blocks_columns', 10, 2 );
