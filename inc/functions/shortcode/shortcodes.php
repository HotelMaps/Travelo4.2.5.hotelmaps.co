...
class TravShortcodes {
	...
	* **************************************************************** */
	...
	/* Location Block Shortcode */
	function shortcode_location_block( $atts, $content = null ) {
		require_once dirname( __FILE__ ) . '/modern/location-block.php';
		$output = trav_shortcode_modern_location_block( $atts, $content );
		return $output;	
	}
