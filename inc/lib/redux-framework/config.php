...
Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
        ...
        array(
            ...
            'default'  => false,
            'required' => array( 'website_style', '!=', 'modern' ),
        ),
        array(
            'id'       => 'modal_login',
            'type'     => 'switch',
...
Redux::setSection( $opt_name, array(
    'title'      => __( 'Site Skin, Style & Layout', 'trav' ),
    'id'         => 'skin-settings',
    'subsection' => true,
    'fields'     => array(
        array(
            'id'        => 'website_style',
            'type'      => 'select',
            'title'     => esc_html__( 'Website Style', 'trav' ),
            'options'   => array(
                'default'   => esc_html__( 'Default', 'trav' ),
                'modern'    => esc_html__( 'Modern', 'trav' ),
            ),
            'default'   => 'default',
        ),
        array(
        ...
        array(
            'id'       => 'enable_gap',
            'type'     => 'switch',
            'title'    => __( 'Gap Enabled', 'trav' ),
            'subtitle' => __( 'Enable Gap', 'trav' ),
            'default'  => false,
            'required' => array( 'website_style', '=', 'modern' ),
        ),
        array(
            'id'        =>  'website_margin',
            'type'      =>  'slider',
            'title'     =>  esc_html__( 'Website Left/Right Margin', 'trav' ),
            'min'       =>  0,
            'step'      =>  1,
            'max'       =>  100,
            'default'   =>  50,
        ...
        array(
            ...
            'type'     => 'color',
            'title'    => __('Site Primary Color', 'trav'), 
            'subtitle' => __('Select Primary Color', 'trav'),
            'transparent'   => false,
            'default'       => '#01b7f2',
            'required' => array( 'website_style', '=', 'modern' ),
        ),
        array(
            ...
            'type'     => 'color',
            'title'    => __('Site Secondary Color', 'trav'), 
            'subtitle' => __('Select Secondary Color', 'trav'),
            'transparent'   => false,
            'default'       => '#fdb714',
            'required' => array( 'website_style', '=', 'modern' ),
        ),
        array(
            'id'       => 'site_third_color',
            'type'     => 'color',
            'title'    => __('Site Third Color', 'trav'), 
            'subtitle' => __('Select Third Color', 'trav'),
            'transparent'   => false,
            'default'       => '#72be2e',
            'required' => array( 'website_style', '=', 'modern' ),
        ),
        array(
            'id'       => 'site_fourth_color',
            'type'     => 'color',
            'title'    => __('Site Fourth Color', 'trav'), 
            'subtitle' => __('Select Fourth Color', 'trav'),
            'transparent'   => false,
            'default'       => '#f94068',
            'required' => array( 'website_style', '=', 'modern' ),
        ),
        array(
            'id'            => 'body_font_family',
            'type'          => 'typography',
            'title'         => esc_html__( 'Body Font', 'trav' ),
            'google'        => true,
            'subsets'       => false,
            'text-align'    => false,
            'font-style'    => false,
            ...
            'preview'       => array(
                'text'              => esc_html__( '"Travelo" is Awesome!!!', 'trav' ),
                'always_dispolay'   => true
            ),
            'required' => array( 'website_style', '=', 'modern' ),
        ),
    )
...
Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
        ...
        array(
            ...
            'type'     => 'media',
            'url'      => true,
            'title'    => __( 'Sticky Logo Image', 'trav' ),
            'compiler' => 'true',
            'desc'     => '',
            'subtitle' => __( 'Set an image file for your logo', 'trav' ),
            'default'  => array( 'url' => TRAV_TEMPLATE_DIRECTORY_URI . "/images/logo.png" ),
        ...
        array(
            ...
            'units'          => 'px',    // You can specify a unit value. Possible: px, em, %
            'units_extended' => 'false',  // Allow users to select any type of unit
            'title'          => __( 'Sticky Menu Logo Height', 'trav' ),
            'subtitle'  => __( 'Set height of logo in sticky menu ( fixed menu bar at the top while scrolling. ). ', 'trav' ),
            'desc'           => __( 'Leave blank to use default value that supported by theme', 'trav' ),
            'width'         => false,
            'default'        => array(),
        ),
    ...
    'fields'     => array(
        ...
        array(
            ...
            'options'  => array(
                'header8'      => array(
                    'alt'   => 'header8', 
                    'img'   => TRAV_IMAGE_URL . '/admin/header/h8.jpg'
                ),
                'header9'      => array(
                    'alt'   => 'header9', 
                    'img'   => TRAV_IMAGE_URL . '/admin/header/h9.jpg'
                ),
            ),
            'default' => 'header8',
        ),        
        /*array(
            'id'        =>  'header_overlap',
            'type'      =>  'switch',
            'title'     =>  esc_html__( 'Header above the content', 'trav' ),
            'subtitle'  =>  esc_html__( 'Overlap page content with this header.', 'trav' ),
            'default'   =>  0,
            'required'      => array( 'website_style', '=', 'modern' ),
        ),*/
        /*array(
            'id'            =>  'header_bg_clr',
            'title'         =>  esc_html__( 'Header Background Color', 'trav' ),
            'type'          =>  'color',
            'default'       =>  '#fff',
            'transparent'   =>  false,
            'validate'      =>  'color',
            'required'      => array( 'header_overlap', '!=', '1' ),
        ),*/
        array(
            'id'            =>  'sticky_header_setting',
            'title'         =>  esc_html__( 'Sticky Header', 'trav' ),
            'type'          =>  'switch',
            'on'            =>  esc_html__( 'Enable', 'trav' ),
            'off'           =>  esc_html__( 'Disable', 'trav' ),
            'default'       =>  1,
            'required'      => array( 'website_style', '=', 'modern' ),
        ),      
        array(
            'id'            =>  'sticky_header_bg_color',
            'title'         =>  esc_html__( 'Sticky Header Background Color', 'trav' ),
            'type'          =>  'color',
            'default'       =>  '#fff',
            'transparent'   =>  false,
            'validate'      =>  'color',
            'required'      => array( 'sticky_header_setting', '=', '1' ),
        ),
        
        array(
            'id'            =>  'nav_menu_color',
            'title'         =>  esc_html__( 'Nav Menu Color', 'trav' ),
            'type'          =>  'color',
            'default'       =>  '#6c7578',
            'transparent'   =>  false,
            'validate'      =>  'color',
        ...
        array(
            'id'            =>  'nav_menu_hover_color',
            'title'         =>  esc_html__( 'Nav Menu Hover Color', 'trav' ),
            'type'          =>  'color',
            'default'       =>  '#1e2325',
            'transparent'   =>  false,
            'validate'      =>  'color',
        ...
        array(
            ...
            'type'      =>  'switch',
            'title'     =>  esc_html__( 'Enable/Disable Language Switcher', 'trav' ),
            'default'   =>  1,
            'required'      => array( 'website_style', '=', 'modern' ),
        ),
        array(
            'id'        =>  'header_currency_switch',
            'type'      =>  'switch',
            'title'     =>  esc_html__( 'Enable/Disable Currency Switcher', 'trav' ),
            'default'   =>  1,
            'required'      => array( 'website_style', '=', 'modern' ),
        ),
...
Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
        ...
        array(
            'id'        => 'acc_footer_content',
            'title'     => esc_html__( 'Accommodation List Page Footer Content', 'panagea' ),
            'type'      => 'select',
            'data'      => 'posts',
                'args'      => array(
