...
<div class="edit-profile">
	...
	<form class="edit-profile-form" method="post" enctype='multipart/form-data'>
		...
		<div class="col-sm-9 no-padding no-float">
			...
			<div class="row form-group upload-photo-field">
				<div class="col-sms-12 col-sm-6">
					<div class="fileinput full-width small-box">
						<input name="photo" type="file" class="input-text" data-placeholder="<?php echo esc_attr__( 'select image/s', 'trav' ); ?>" accept="image/*">
					</div>
				</div>
				<div class="col-sms-12 col-sm-6">
			...
			<div class="form-group">
				<textarea name="description" rows="5" class="input-text full-width" placeholder="<?php echo esc_attr__( 'please tell us about you', 'trav' ); ?>"><?php echo esc_textarea( $user_info['description'] ); ?></textarea>
			</div>
