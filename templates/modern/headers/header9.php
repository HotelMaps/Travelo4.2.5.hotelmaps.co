<?php global $logo_url, $my_account_page, $login_url, $signup_url, $language_count; ?>
<header class="main-header header-style-2">
	<div class="site-header-wrapper">				
		<div class="header-container">
			<div class="site-logo">
				<a href="<?php echo home_url(); ?>" rel="home"><img src="<?php echo esc_url( $logo_url ); ?>" alt="<?php bloginfo('name'); ?>"></a>
			</div>
				...
				<div class="multi-lang-cur-setting">
					<?php if ( trav_is_multi_currency() && trav_get_opt( 'header_currency_switch' ) ) : ?>
						<div class="multi-currency dropdown">
							<a class="currency-link dropdown-toggle" href="#" id="multi-curr-Dropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="label"><?php echo esc_html( trav_get_user_currency() ); ?></span></a>
					...
					<?php if ( trav_get_opt( 'header_lang_switch' ) ) : ?>
						...
						<div class="multi-language dropdown">
							<a class="language-link dropdown-toggle" href="#" id="multi-lang-Dropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="label"><?php echo ICL_LANGUAGE_NAME ; ?></span></a>
