...
if ( $booking_data['status'] == 1 ) { // if upcoming 
    trav_get_template( 'booking-success.php', '/templates/modern/accommodation/' ); 
} elseif ( $booking_data['status'] == 0 ) { // if canceled 
    trav_get_template( 'booking-cancelled.php', '/templates/modern/accommodation/' ); 
} elseif ( $booking_data['status'] == 2 ) { // if completed 
    trav_get_template( 'booking-completed.php', '/templates/modern/accommodation/' ); 
}