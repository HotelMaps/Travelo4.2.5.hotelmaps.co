...
...
    <script type="text/javascript" src="https://script.crazyegg.com/pages/scripts/0040/9118.js" async="async"></script>
</head>

<body <?php body_class( trav_get_current_style() . '-style' ); ?>>
    <?php
    if ( trav_get_current_style() == 'modern' ) {
        trav_get_template( 'header.php', '/templates/modern/headers/' ); 
    } else {
    ?>
        <div id="page-wrapper">
